...
Film a **phone screen** showing a real Telegram group with 3 people. Judges
should see the agents living somewhere real, not a localhost dashboard.

Pre-load: bot in the group, 3 members have each sent a message (this seeds the
transcript the mediator and nudge agents reason over).
...
narrate over the "Reading the receipt..." message.

## Submission checklist
- [ ] Project title + written description
- [ ] Public GitHub repo (push before 15:00)
- [ ] 2-minute video
- [ ] Social post tagging the partners — **people forget this one**
